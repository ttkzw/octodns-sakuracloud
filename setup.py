...
def version():
    with open('octodns_sakuracloud/__init__.py') as fh:
        for line in fh:
...
setup(
    ...
    author_email='taki@cyber.email.ne.jp',
    ...
    install_requires=('octodns>=1.10.0', 'requests>=2.32.0'),
    license='MIT',
    long_description=long_description,
    long_description_content_type='text/markdown',
    name='octodns-sakuracloud',
